...
class Kohana_Pagination {
    ...
    public function getNormalUri($num){

        $params = !empty($this->config['get_params'])? '?'.http_build_query($this->config['get_params']):'';
        return $this->config['first_page_in_url'].
        '/'.$this->config['current_page']['key'] . $num .$params;
    }
