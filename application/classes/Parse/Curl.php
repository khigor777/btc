...
class Parse_Curl {
     ...
     * @return mixed
     */
    public  function getPageCurl($url, $uri_params = array(), $curl_params = array())
        {
            $param = '';
            if (!empty($uri_params)) {
                $param .= '?' . http_build_query($uri_params);
            }
            $url .= $param;
            $curl = curl_init($url);
            $setop = array(
            ...
            $setop = $setop + $curl_params;
            curl_setopt_array($curl, $setop);
     ...
     * @return mixed
     */
    public  function postCurl($url, $params, $curl_params = array()) {
            $ch = curl_init();
            $op = array(
                CURLOPT_URL => $url,
                CURLOPT_RETURNTRANSFER => true,
